...
const TokenPassword = lazy(() => import("./TokenPassword"));
const LegalDocumentsView = lazy(() => import("./LegalDocumentsView"));
...
const routeFallback = <div className="app-route-loading">Cargando...</div>;
